#ifndef STRBLOBPTR_EX55_H
#define STRBLOBPTR_EX55_H
...
public:
    ...
    string &front() const;
    string &back() const;
    void push_back(const string& s) { data->push_back(s); cout << "copy push\n"; }
    void push_back(string && s) { data->push_back(std::move(s)); cout << "move push\n"; }
    void pop_back();
    StrBlobPtr begin();
    StrBlobPtr end();
